...
public class SiteInfoApiAdapter implements SiteInfoApiPort {
    ...
    public SiteInfo fetchSiteInfo() {
        ...
        CompletableFuture<GetSiteInfoResponseApi> call1 = CompletableFuture.supplyAsync(() ->
            client.coreWebservice().getSiteInfo(new GetSiteInfoRequestApi()), executor
        );

        CompletableFuture<GetPublicConfigResponseApi> call2 = CompletableFuture.supplyAsync(() ->
