...
public interface GetCourseLogsMetricsMapper {
  ...
  @Mapping(
      target = "fillGapsStrategy",
      source = "courseLogsMetricsRequestDto.fillGapsStrategy",
      defaultValue = "NONE")
  CourseLogsMetricsRequest toDomain(
  ...
  CourseLogsMetricsResponseRowComponentDto toCourseLogsMetricsResponseRowComponentDto(
      MetricRow source);
