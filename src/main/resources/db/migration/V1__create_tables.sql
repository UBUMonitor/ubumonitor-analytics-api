...
-- =========================
-- USER_COURSE (JOIN TABLE + EXTRA FIELDS)
-- =========================
...
CREATE INDEX idx_logs_course_user ON logs (course_id, user_id);

CREATE INDEX idx_logs_course_ts ON logs (course_id, timestamp);
